        ...
        link.addEventListener('click', function(e) {
            ...
            modal.innerHTML = `
                <div class="modal-content">
                    ...
                    <h2 class="modal-title">Статья в разработке</h2>
                    <div class="modal-section">
                        <p class="modal-text">Полная версия статьи скоро будет доступна. А пока вы можете записаться на консультацию, чтобы обсудить эту тему лично.</p>
                    </div>
