        ...
        content: `
            ...
            <div class="article-body">
                ...
                <div class="action-section">
                    ...
                    <button class="btn btn-primary" id="articleConsultationBtn" data-service-type="mediation">Записаться на медиацию</button>
                </div>
            </div>
        `
    },
        ...
        content: `
            ...
            <div class="article-body">
                ...
                <div class="action-section">
                    ...
                    <button class="btn btn-primary" id="articleConsultationBtn" data-service-type="personality-code">Записаться на диагностику</button>
                </div>
            </div>
        `
    },
        ...
        content: `
            ...
            <div class="article-body">
                ...
                <div class="action-section">
                    ...
                    <button class="btn btn-primary" id="articleConsultationBtn" data-service-type="profiling">Записаться на профайлинг</button>
                </div>
            </div>
        `
    }
...
// ========== ИСПРАВЛЕНИЕ КНОПОК В СТАТЬЯХ ==========

// Улучшенная функция для кнопки "Записаться на консультацию"
function setupArticleConsultationButton() {
...
function showArticle(articleId) {
    ...
    setTimeout(setupArticleConsultationButton, 100);
}
...
function submitSitemapToSearchEngines() {
...
console.log('VERITAS CODE psychology website with advanced SEO and security features initialized');